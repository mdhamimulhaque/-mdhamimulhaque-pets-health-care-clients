...
import loaderGif from "../../img/loader-Img.gif";
        ...
        <>
            <PageHeader />
            {
                services ?
                        ...
                        <div className="bg-gray-100 sm:grid grid-cols-5  px-4 py-6 min-h-full lg:min-h-screen space-y-6 sm:space-y-0 sm:gap-4">
                            ...
                            <div className="h-96 col-span-1">
                                <div className="bg-white py-3 px-4 rounded-lg flex justify-around items-center ">
                                    <input type="text" placeholder="search" className=" bg-gray-100 rounded-md  outline-none pl-2 ring-rose-700 w-full mr-2 p-2" />
                    ...
                    : <div className="loader_area h-screen w-screen flex justify-center items-center">
